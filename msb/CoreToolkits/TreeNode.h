...
namespace kome {
	namespace core {
		...
		public:
             ...
             * @return parent node. ( If this node has no parent, this method returns nullptr )
			 */
             ...
             * @return child node ( If there is no child node that has index specified, this method returns nullptr )
			 */
