...
/**
 * @fn void outputlog( const char* msg, int level, const char* file = nullptr, int line = -1)
 * @brief output log
 ...
 */
void outputlog( const char* msg, int level, const char* file = nullptr, int line = -1);

/**
 * @fn void logfatal( const char* msg, const char* file = nullptr, int line = -1 )
 * @brief output fatal log
 * @param[in] msg log message
 * @param[in] file source file name
 * @param[in] line line number
 */
void logfatal( const char* msg, const char* file = nullptr, int line = -1 );

/**
 * @fn void logfatalcode( int code, const char* msg, const char* file = nullptr, int line = -1 )
 ...
 * @param[in] line line number
 */
void logfatalcode( int code, const char* msg, const char* file = nullptr, int line = -1 );

/**
 * @fn void logerror( const char* msg, const char* file = nullptr, int line = -1 )
 * @brief output error log
 * @param msg log message
 * @param file source file name
 * @param line line number
 */
void logerror( const char* msg, const char* file = nullptr, int line = -1 );

/**
 * @fn void logerrorcode( int code, const char* msg, const char* file = nullptr, int line = -1 )
 ...
 * @param[in] line line number
 */
void logerrorcode( int code, const char* msg, const char* file = nullptr, int line = -1 );

/**
 * @fn void logwarn( const char* msg, const char* file = nullptr, int line = -1 )
 * @brief output warning log
 * @param[in] msg log message
 * @param[in] file source file name
 * @param[in] line line number
 */
void logwarn( const char* msg, const char* file = nullptr, int line = -1 );

/**
 * @fn void logwarncode( int code, const char* msg, const char* file = nullptr, int line = -1 )
 ...
 * @param[in] line line number
 */
void logwarncode( int code, const char* msg, const char* file = nullptr, int line = -1 );

/**
 * @fn void loginfo( const char* msg, const char* file = nullptr, int line = -1 )
 * @brief output information log
 * @param[in] msg log message
 * @param[in] file source file name
 * @param[in] line line number
 */
void loginfo( const char* msg, const char* file = nullptr, int line = -1 );

/**
 * @fn void loginfocode( int code, const char* msg, const char* file = nullptr, int line = -1 )
 ...
 * @param[in] line line number
 */
void loginfocode( int code, const char* msg, const char* file = nullptr, int line = -1 );

/**
 * @fn void logdebug( const char* msg, const char* file = nullptr, int line = -1 )
 * @brief output debug log
 * @param[in] msg log message
 * @param[in] file source file name
 * @param[in] line line number
 */
void logdebug( const char* msg, const char* file = nullptr, int line = -1 );

/**
 * @fn void logdebugcode( int code, const char* msg, const char* file = nullptr, int line = -1 )
 ...
 * @param[in] line line number
 */
void logdebugcode( int code, const char* msg, const char* file = nullptr, int line = -1 );

/**
 * @fn void logtrace( const char* msg, const char* file = nullptr, int line = -1 )
 * @brief output trace log
 * @param[in] msg log message
 * @param[in] file source file name
 * @param[in] line line number
 */
void logtrace( const char* msg, const char* file = nullptr, int line = -1 );

/**
 * @fn void logtracecode( int code, const char* msg, const char* file = nullptr, int line = -1 )
 ...
 * @param[in] line line number
 */
void logtracecode( int code, const char* msg, const char* file = nullptr, int line = -1 );
