...
/**
 * @fn bool isint( const char* s, const int radix = 10, int* val = nullptr )
 ...
 * @param[out] val If sutisfied character string is integer number, the number is stored in val.
              If val is nullptr, the number is not stored.
 * @return If sutiffied character string shows integer number, this function returns true.
 */
bool isint( const char* s, const int radix = 10, int* val = nullptr );
...
/**
 * @fn bool isint64( const char* s, const int radix = 10, long long* val = nullptr )
 ...
 * @return If sutiffied character string shows integer number, this function returns true.
 */
bool isint64( const char* s, const int radix = 10, long long* val = nullptr );
...
/**
 * @fn bool isdouble( const char* s, double* val = nullptr )
 ...
 */
bool isdouble( const char* s, double* val = nullptr );
